...
function (_Base) {
  ...
  _createClass(Sketchpad, [{
    ...
    value: function attach() {
      ...
      this.editSketchpad.canvas.svg.addEventListener('mousedown', function (e) {
        ...
        if (_this5.modes[_this5.state.mode].eventStart) {
          _this5.modes[_this5.state.mode].eventStart(_this5.getActualCoordinates({
        ...
        var mouseDrag = function mouseDrag(e) {
          ...
          if (_this5.modes[_this5.state.mode].drag) {
            _this5.modes[_this5.state.mode].drag(_this5.getActualCoordinates({
              x: e.clientX - offset.left,
              y: e.clientY - offset.top
            }));
          }
        ...
        var mouseEnd = function mouseEnd(e) {
          ...
          if (_this5.modes[_this5.state.mode].eventEnd) {
            _this5.modes[_this5.state.mode].eventEnd(_this5.getActualCoordinates({
              x: e.clientX - offset.left,
              y: e.clientY - offset.top
            }));
          }
    ...
    value: function setBackgroundImage(svgMarkup) {
      ...
      svgMarkup = new XMLSerializer().serializeToString(backgroundSvg); //fix weird issue in Chrome when it retured '<svg:svg>...</svg:svg>' string after serialization instead of <svg>...</svg>

      svgMarkup = svgMarkup.replace('<svg:svg', '<svg').replace('</svg:svg>', '</svg>');
      this.editSketchpad.background.container.style['min-width'] = "".concat(this.dimensions.width, "px");
      this.editSketchpad.background.container.style['min-height'] = "".concat(this.dimensions.height, "px"); //set background containers content to SVG markup
